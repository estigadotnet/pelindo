 ...
 * Page class
 */
class t0002_jasa_view extends t0002_jasa
{
	...
	// Page object name
	public $PageObjName = "t0002_jasa_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t0002_jasalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t0002_jasalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t0002_jasalist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
