...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'nFVieH09hGuUZ5zi'); // Random key for encryption
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_pelindo", "qs" => "`", "qe" => "`");
